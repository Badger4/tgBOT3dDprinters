...
def set_user_lang(user_data: dict[str, Any], lang: str) -> dict[str, Any]:
    """Sets language preference ('uk' or 'en') in user dictionary."""
    if not isinstance(user_data, dict):
        user_data = {}
    user_data["language"] = "en" if str(lang).lower() in ["en", "english"] else "uk"
    return user_data
